...
L<verify(1)> for additional details.
(Optional)

=item B<-CAstore uri>

A URI to a store containing the trusted CA certificates for the client.
...
=item At least one of B<-CApath>, B<-CAfile> or B<-CAstore> must be specified.

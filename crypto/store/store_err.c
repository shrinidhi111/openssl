...
static ERR_STRING_DATA STORE_str_functs[] = {
    ...
    {ERR_FUNC(STORE_F_STORE_FILE_HANDLER_NEW), "STORE_FILE_HANDLER_new"},
    {ERR_FUNC(STORE_F_STORE_FILE_HANDLER_SET0_NAME),
     "STORE_FILE_HANDLER_set0_name"},
    {ERR_FUNC(STORE_F_STORE_FILE_HANDLER_SET_DESTROY_CTX),
     "STORE_FILE_HANDLER_set_destroy_ctx"},
    {ERR_FUNC(STORE_F_STORE_FILE_HANDLER_SET_EOF),
     "STORE_FILE_HANDLER_set_eof"},
    {ERR_FUNC(STORE_F_STORE_FILE_HANDLER_SET_TRY_DECODE),
     "STORE_FILE_HANDLER_set_try_decode"},
    ...
    {ERR_FUNC(STORE_F_STORE_INFO_NEW_DSAPARAMS), "STORE_INFO_new_DSAPARAMS"},
    {ERR_FUNC(STORE_F_STORE_INFO_NEW_ECPARAMS), "STORE_INFO_new_ECPARAMS"},

...
static ERR_STRING_DATA STORE_str_functs[] = {
    ...
    {ERR_FUNC(STORE_F_FILE_NAME_TO_URI), "file_name_to_uri"},
    {ERR_FUNC(STORE_F_FILE_OPEN), "file_open"},
    {ERR_FUNC(STORE_F_STORE_EXPECT), "STORE_expect"},
    {ERR_FUNC(STORE_F_STORE_FIND), "STORE_find"},
    {ERR_FUNC(STORE_F_STORE_INFO_NEW_CERT), "STORE_INFO_new_CERT"},
    {ERR_FUNC(STORE_F_STORE_INFO_NEW_CRL), "STORE_INFO_new_CRL"},
    {ERR_FUNC(STORE_F_STORE_INFO_NEW_DECODED), "store_info_new_DECODED"},
    ...
    {ERR_FUNC(STORE_F_STORE_SEARCH_BY_ALIAS), "STORE_SEARCH_by_alias"},
    {ERR_FUNC(STORE_F_STORE_SEARCH_BY_ISSUER_SERIAL),
     "STORE_SEARCH_by_issuer_serial"},
    {ERR_FUNC(STORE_F_STORE_SEARCH_BY_KEY_FINGERPRINT),
     "STORE_SEARCH_by_key_fingerprint"},
    {ERR_FUNC(STORE_F_STORE_SEARCH_BY_NAME), "STORE_SEARCH_by_name"},
    {ERR_FUNC(STORE_F_STORE_SUPPORTS_SEARCH), "STORE_supports_search"},
...
static ERR_STRING_DATA STORE_str_reasons[] = {
    ...
    {ERR_REASON(STORE_R_LOADING_STARTED), "loading started"},

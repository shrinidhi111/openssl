...
# define SSL_CTRL_SET_TMP_PKEY                   5
...
# define SSL_CTX_set_tmp_pkey(ctx,pkey) \
        SSL_CTX_ctrl(ctx,SSL_CTRL_SET_TMP_PKEY,0,(char *)(pkey))
...
# define SSL_set_tmp_pkey(ssl,pkey) \
        SSL_ctrl(ssl,SSL_CTRL_SET_TMP_PKEY,0,(char *)(pkey))
